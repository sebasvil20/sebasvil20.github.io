...
const Header = () => {
  return (
    <header className="text-gray-700  z-50 ">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center  text-magnolia z-50">
        <a className="flex items-center mb-4 md:mb-0" href="!#">
          <span className="font-quicksand font-bold ml-3 text-xl z-50">
            Sebastián Villegas
          </span>
        </a>
